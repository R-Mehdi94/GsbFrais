   ...
   class ConnexionBdd{
        ...
        public static function verifInsertFicheFrais($idVisiteur){
            ...
            try{
                ...
                $sql = 'select count(idVisiteur) from FicheFrais WHERE idVisiteur = :idVisiteur AND idEtat LIKE "CR"';
        ...
        public static function insertFicheFrais($idVisiteur) {
            ...
            try{
                ...
                $mois_nom = strftime('%B', mktime(0, 0, 0, $mois_num, 1));
                ...
                $sql = 'insert into FicheFrais(idVisiteur,mois,AnneeMois)' . 'values(:idVisiteur,:mois, :AnneeMois)';
